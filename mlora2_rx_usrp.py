...
# Title: Mlora2 Rx Usrp
# Generated: Sun Jul 21 19:54:38 2019
##################################################
...
class mlora2_rx_usrp(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Mlora2 Rx Usrp")
        ...
        self.MLoRa_mlora2_receiver_0 = MLoRa.mlora2_receiver(bw, samp_rate, sf, 4, (powers), (byte_lens), 8, 6)

        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.MLoRa_mlora2_receiver_0, 'out'), (self.lora_message_socket_sink_0, 'in'))
        self.connect((self.uhd_usrp_source_0, 0), (self.MLoRa_mlora2_receiver_0, 0))
...
def main(top_block_cls=mlora2_rx_usrp, options=None):
