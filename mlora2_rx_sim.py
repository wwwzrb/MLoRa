...
# Title: Mlora2 Rx Sim
# Generated: Sun Jul 21 20:14:58 2019
##################################################
...
class mlora2_rx_sim(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Mlora2 Rx Sim")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/wangzhe/sjtu/USRP/MLoRa/online/data/mlora2_async', False)
        self.MLoRa_mlora2_receiver_0 = MLoRa.mlora2_receiver(bw, samp_rate, sf, 4, (powers), (byte_lens), 8, 4)

        ##################################################
        # Connections
        ##################################################
        self.msg_connect((self.MLoRa_mlora2_receiver_0, 'out'), (self.lora_message_socket_sink_0, 'in'))
        self.connect((self.blocks_file_source_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.MLoRa_mlora2_receiver_0, 0))
    ...
    def get_byte_lens(self):
        return self.byte_lens

    def set_byte_lens(self, byte_lens):
        self.byte_lens = byte_lens
...
def main(top_block_cls=mlora2_rx_sim, options=None):
